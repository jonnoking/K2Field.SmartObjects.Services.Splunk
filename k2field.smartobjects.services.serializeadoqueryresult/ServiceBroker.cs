...
namespace K2Field.SmartObject.Services.SerializeADOQueryResult
{
    public class ServiceBroker : ServiceAssemblyBase
    {
        ...
        {
            base.Service.Name = "SerializeADOQueryResult";
            base.Service.MetaData.DisplayName = "Serialize ADO Query Result";
            base.Service.MetaData.Description = "Serialize ADO Query Result";
